export const surveyTheme = {
    ...
    "cssVariables": {
        ...
        "--sjs-editorpanel-hovercolor": "rgba(211, 199, 167, 1)",
        "--sjs-questionpanel-backcolor": "rgba(26, 6, 1, 1)",
        "--sjs-questionpanel-hovercolor": "rgba(26, 6, 1, 1)",
        "--sjs-corner-radius": "4px",
        "--sjs-base-unit": "8px",
        "--sjs-font-pagetitle-color": "rgba(211, 199, 167, 0.79)",
        "--sjs-shadow-small": "0px 0px 2px 1px rgba(211, 199, 167, 0.35)",
        "--sjs-font-questiontitle-color": "rgba(211, 199, 167, 0.78)",
        "--sjs-font-questiondescription-color": "rgba(211, 199, 167, 0.42)",
        "--sjs-shadow-inner": "inset 0px 0px 2px 0px rgba(211, 199, 167, 0.2)",
        "--sjs-font-editorfont-color": "rgba(0, 0, 0, 0.78)",
        "--sjs-font-editorfont-placeholdercolor": "rgba(0, 0, 0, 0.42)",
        "--sjs-border-default": "rgba(211, 199, 167, 0.12)",
        "--sjs-border-light": "rgba(211, 199, 167, 0.08)",
        ...
        "--sjs-shadow-small-reset": "0px 0px 0px 0px rgba(211, 199, 167, 0.35)",
        "--sjs-shadow-medium": "0px 2px 6px 0px rgba(0, 0, 0, 0.2)",
        "--sjs-shadow-large": "0px 8px 16px 0px rgba(0, 0, 0, 0.2)",
        "--sjs-shadow-inner-reset": "inset 0px 0px 0px 0px rgba(211, 199, 167, 0.2)",
        ...
        "--sjs-general-backcolor-dim": "#1a0601",
        "--sjs-primary-backcolor": "#ff2095",
        "--sjs-primary-backcolor-dark": "rgba(255, 32, 149, 1)",
        "--sjs-primary-backcolor-light": "rgba(255, 32, 149, 0.07)",
        "--sjs-primary-forecolor": "rgba(26, 6, 1, 1)",
        "--sjs-primary-forecolor-light": "rgba(26, 6, 1, 0.25)",
        "--sjs-special-red": "rgba(254, 76, 108, 1)",
        "--sjs-special-red-light": "rgba(254, 76, 108, 0.1)",
        "--sjs-font-surveytitle-family": "Garamond, serif"
    },
    "header": {
